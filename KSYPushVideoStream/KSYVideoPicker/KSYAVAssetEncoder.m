...
- (NSString *)getOutputFilePath:(NSString *)fileType {
    ...
    NSString *filePath =  [path stringByAppendingPathComponent:
                           [NSString stringWithFormat:kAVAssetMP4OutputWithRandom, rand() % 9]];
                        ...
                        [assetWriter finishWritingWithCompletionHandler:^{
                            ...
                            @synchronized (self)
                            {
                                ...
                                if (assetWriter.status == AVAssetWriterStatusFailed) {
                                    ...
                                    NSLog(@"movWithMoov.length = %@",@(movWithMoov.length));
                                    NSArray *frames = nil;
                                    KSYMP4Reader *mp4Reader = [[KSYMP4Reader alloc] init];
                                ...
                                if (restartEncoder) {
                                    ...
                                    // in the functions.
                                    if (assetWriter != nil && videoEncoder_.assetWriterInput != nil && audioEncoder_.assetWriterInput != nil) {
